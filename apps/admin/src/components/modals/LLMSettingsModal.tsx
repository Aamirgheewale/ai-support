...
import { Cpu, Save, Shield, Check, AlertCircle, Loader2, AlertTriangle, Plus, LayoutGrid, List, Pencil, Trash2 } from 'lucide-react';
...
const LLMSettingsModal = ({ isOpen, onClose }: LLMSettingsModalProps) => {
    ...
    return (
        ...
        >
            {/* Tabs */}
            <div className="px-6 border-b border-gray-100 dark:border-gray-700 flex gap-6 bg-white dark:bg-gray-900">
                <button
                        ...
                        {activeTab === 'add' && (
                            <form onSubmit={handleUpsert} className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder={formData.provider === 'custom' ? 'e.g. deepseek-coder' : 'e.g. gpt-4o'}
                                            required
                                ...
                                {formData.provider === 'custom' && (
                                    <div>
                                        <label className="block text-sm font-medium mb-1 dark:text-gray-200">Base URL</label>
                                        <input
                                            type="text"
                                        ...
                                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                            API endpoint for OpenAI-compatible providers (e.g., DeepSeek, Together AI, Groq)
                                        </p>
                                    </div>
                                )}
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Required for new models. Leave empty when updating existing models to keep current key.</p>
                                </div>
