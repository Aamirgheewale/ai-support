...
import { Volume2, VolumeX, Bell, PlayCircle, PauseCircle, Loader2 } from 'lucide-react'
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`p-1.5 rounded transition-colors ${ringPlaying
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`p-1.5 rounded transition-colors ${popPlaying
                    ? 'bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/40 text-red-600 dark:text-red-400'
                    : 'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-400 dark:text-gray-500'
                  }`}
